                ...
                <div class="main" style="margin-left: 50px; margin-right: 50px;">
                    ...
                    <form action="update-product-detail" id="productForm" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="productID">Product Image Of Customer:</label>
                        ...
                        <div class="form-group row">
                            <div class="col-10">  
                                ...
                                <textarea disabled="" name="detail" id="detail" required="" class="form-control" aria-label="With textarea">${feedback.getProductDescription()}</textarea>
                            </div>
                        </div>
