...
@WebServlet(name="AddNewSlider", urlPatterns={"/addSlider"})
public class AddNewSlider extends HttpServlet {
    ...
    throws ServletException, IOException {
        request.getRequestDispatcher("marketing/marketing-add-slider.jsp").forward(request, response);
    } 
    ...
    throws ServletException, IOException {
        ...
        response.sendRedirect("marketing/manageSlider");
    }
