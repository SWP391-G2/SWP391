...
VALUES
-- 20 perfumes for Men
('XERJOFF CASAMORATI MEFISTO EDP FOR MEN','2024-01-01',1,3,'1_0.jpg',1),
('LOUIS VUITTON MÉTÉORE EDP FOR MEN','2024-01-01',1,4,'2_0.jpg',1),
('TOMMY ENDLESS BLUE FOR MEN','2024-01-01',1,6,'3_0.jpg',1),
('ISSEY MIYAKE LEAU DISSEY INTENSE FOR MEN','2024-01-01',1,7,'4_0.jpg',1),
('CREED AVENTUS EDP FOR MEN','2024-01-01',1,8,'5_0.jpg',1),
('DIOR SAUVAGE EDP FOR MEN','2024-01-01',1,5,'6_0.jpg',1),
('BLEU DE CHANEL EDP FOR MEN','2024-01-01',1,2,'7_0.jpg',1),
('YVES SAINT LAURENT LA NUIT DE L''HOMME EDT FOR MEN','2024-01-01',1,9,'8_0.jpg',1),
('VERSACE DYLAN BLUE POUR HOMME FOR MEN','2024-01-01',1,14,'9_0.jpg',1),
('ARMAF VENTANA POUR HOMME EDP FOR MEN','2024-01-01',1,10,'10_0.jpg',1),
('BVLGARI WOOD NEROLI EDP FOR MEN','2024-01-01',1,13,'11_0.jpg',1),
('VERSACE EAU FRAICHE EDT FOR MEN','2024-01-01',1,14,'12_0.jpg',1),
('GUCCI GUILTY ABSOLUTE POUR HOMME FOR MEN','2024-01-01',1,1,'13_0.jpg',1),
('YVES SAINT LAURENT Y EDP FOR MEN','2024-01-01',1,9,'14_0.jpg',1),
('ROJA ENIGMA POUR HOMME FOR MEN','2024-01-01',1,11,'15_0.jpg',1),
('BVLGARI SPLENDIDA JASMIN NOIR EDP FOR MEN','2024-01-01',1,13,'16_0.jpg',1),
('CHANEL ANTAEUS POUR HOMME EDT FOR MEN','2024-01-01',1,2,'17_0.jpg',1),
('DIOR HOMME SPORT EDT FOR MEN','2024-01-01',1,5,'18_0.jpg',1),
('VERSACE EROS FLAME FOR MEN','2024-01-01',1,14,'19_0.jpg',1),
('ISSEY MIYAKE NUIT DISSEY EDT FOR MEN','2024-01-01',1,7,'20_0.jpg',1),

-- 20 perfumes for Women
('CHANEL CHANCE EDP FOR WOMEN','2024-01-01',1,2,'1_0.jpg',2),
('DIOR JOY EDP FOR WOMEN','2024-01-01',1,5,'2_0.jpg',2),
('YSL LIBRE EDP FOR WOMEN','2024-01-01',1,9,'3_0.jpg',2),
('LOUIS VUITTON SPELL ON YOU EDP FOR WOMEN','2024-01-01',1,4,'4_0.jpg',2),
('CHANEL CHANCE EAU FRAICHE EDP FOR WOMEN','2024-01-01',1,2,'5_0.jpg',2),
('LANCOME LA VIE EST BELLE EN ROSE FOR WOMEN','2024-01-01',1,15,'6_0.jpg',2),
('LANCOME TRESOR LA NUIT EDP FOR WOMEN','2024-01-01',1,15,'7_0.jpg',2),
('LANCOME LA VIE EST BELLE EDP FOR WOMEN','2024-01-01',1,15,'8_0.jpg',2),
('GUCCI BLOOM AMBROSIA DI FIORI EDP FOR WOMEN','2024-01-01',1,1,'9_0.jpg',2),
('BVLGARI ROSE GOLDEA FOR WOMEN','2024-01-01',1,13,'10_0.jpg',2),
('ARMAF CLUB DE NUIT FOR WOMEN','2024-01-01',1,10,'11_0.jpg',2),
('GUCCI FLORA GORGEOUS GARDENIA EDP FOR WOMEN','2024-01-01',1,1,'12_0.jpg',2),
('TOMMY GIRL EDT FOR WOMEN','2024-01-01',1,6,'13_0.jpg',2),
('ROJA ELIXIR POUR FEMME FOR WOMEN','2024-01-01',1,11,'14_0.jpg',2),
('CHANEL COCO MADEMOISELLE EDP FOR WOMEN','2024-01-01',1,2,'15_0.jpg',2),
('LOUIS VUITTON MATIERE NOIRE FOR WOMEN','2024-01-01',1,4,'16_0.jpg',2),
('LOUIS VUITTON CALIFORNIA DREAM FOR WOMEN','2024-01-01',1,4,'17_0.jpg',2),
('GUCCI BLOOM EDP FOR WOMEN','2024-01-01',1,1,'18_0.jpg',2),
('CHANEL COCO NOIR FOR WOMEN','2024-01-01',1,2,'19_0.jpg',2),
('VERSACE DYLAN BLUE POUR FEMME EDP FOR WOMEN','2024-01-01',1,14,'20_0.jpg',2),

-- 20 perfumes for Unisex
('XERJOFF NAXOS EDP FOR UNISEX','2024-01-01',1,3,'1_0.jpg',3),
('ARMAF STERLING CLUB DE NUIT MILESTONE EDP FOR UNISEX','2024-01-01',1,10,'2_0.jpg',3),
('GUCCI A SONG FOR THE ROSE EDP FOR UNISEX','2024-01-01',1,1,'3_0.jpg',3),
('LE LABO THE NOIR 29 EDP FOR UNISEX','2024-01-01',1,12,'4_0.jpg',3),
('LOUIS VUITTON OMBRE NOMADE EDP FOR UNISEX','2024-01-01',1,4,'5_0.jpg',3),
('CREED SILVER MOUNTAIN WATER FOR UNISEX','2024-01-01',1,8,'6_0.jpg',3),
('LE LABO BERGAMOTE 22 EDP FOR UNISEX','2024-01-01',1,12,'7_0.jpg',3),
('LE LABO SANTAL 33 FOR UNISEX','2024-01-01',1,12,'8_0.jpg',3),
('ROJA DOVE AMBER AOUND PARFUM FOR UNISEX','2024-01-01',1,11,'9_0.jpg',3),
('LOUIS VUITTON CACTUS GARDEN EDP FOR UNISEX','2024-01-01',1,4,'10_0.jpg',3),
('LOUIS VUITOTN SUN SONG EDP FOR UNISEX','2024-01-01',1,4,'11_0.jpg',3),
('ROJA DOVE MANHATTAN EDP FOR UNISEX','2024-01-01',1,11,'12_0.jpg',3),
('ROJA DOVE BURLINGTON 1819 PARFUM FOR UNISEX','2024-01-01',1,11,'13_0.jpg',3),
('XERJOFF ALEXANDRIA II FOR UNISEX','2024-01-01',1,3,'14_0.jpg',3),
('BVLGARI SPLENDIDA MAGNOLIA SENSUEL EDP FOR UNISEX','2024-01-01',1,13,'15_0.jpg',3),
('ARMAF CLUB DE NUIT UNTOLD EDP FOR UNISEX','2024-01-01',1,10,'16_0.jpg',3),
('GUCCI BLOOM ACQUA DI FIORI EDT','2024-01-01',1,1,'17_0.jpg',3),
('CHANEL GABRIELLE ESSENCE EDP','2024-01-01',1,2,'18_0.jpg',3),
('VERSACE YELLOW DIAMOND INTENSE EDP FOR UNISEX','2024-01-01',1,14,'19_0.jpg',3),
('CHANEL ALLURE HOMME SPORT COLOGNE FOR UNISEX','2024-01-01',1,2,'20_0.jpg',3),

-- 5 Giftsets 
('SET YSL BLACK OPIUM EDP FOR GIFT SET','2024-01-01',1,9,'1_0.jpg',4),
('SET BVLGARI OMNIA FOR GIFT SET','2024-01-01',1,13,'2_0.jpg',4),
('SET OF 5 LANCOME PARIS PERFUMES FOR GIFT SET','2024-01-01',1,15,'3_0.jpg',4),
('BVLGARI OMNIA AMETHYSTE FOR GIFT SET','2024-01-01',1,13,'4_0.jpg',4),
('VERSACE BRIGHT CRYSTAL ABSOLU FOR GIFT SET','2024-01-01',1,14,'5_0.jpg',4);
